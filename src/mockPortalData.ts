...
export const roleMeta: Record<UserRole, RoleMeta> = {
  ...
  nurse: {
    ...
    credentialLabel: 'COREN ou matricula',
    description:
      'Tela de triagem para sinais, prioridade e encaminhamento ao medico.',
    route: '/portal/nurse',
  },
  collector: {
...
export const demoAccounts: DemoAccount[] = [
  {
    id: 'u-pop-01',
    role: 'population',
    name: 'Usuario Morador Demo',
    identifier: 'MORADOR-DEMO-001',
    territory: 'Comunidade Demo - Setor Ribeirinho',
  },
  {
    id: 'u-doc-01',
    role: 'doctor',
    name: 'Medica Demo',
    identifier: 'CRM-DEMO-001',
    territory: 'Unidade Demo de Saude',
  },
  {
    id: 'u-nur-01',
    role: 'nurse',
    name: 'Enfermagem Demo',
    identifier: 'ENF-DEMO-001',
    territory: 'Unidade Demo de Saude',
  },
  {
    id: 'u-col-01',
    role: 'collector',
    name: 'Agente de Campo Demo',
    identifier: 'AGT-DEMO-001',
    territory: 'Equipe de campo demo',
  },
  {
    id: 'u-admin-01',
    role: 'admin',
...
export const dashboardMocks: DashboardByRole = {
    ...
    cases: [
      {
        ...
        priorityGroup: 'Gestante',
        symptoms: 'Dormencia nas maos, cefaleia recorrente e tontura.',
        exposureSummary: 'Consumo de peixe local em quase todos os dias da semana.',
        clinicalNote: '',
        lastAction: 'Aguardando conduta',
        updatedAt: '24/04/2026 08:55',
      },
      {
        id: 'mock-case-2',
        ...
        priorityGroup: 'Crianca',
        symptoms: 'Tremor leve e dificuldade de concentracao relatada pela familia.',
        exposureSummary: 'Consumo frequente de jaraqui e tucunare.',
        clinicalNote: '',
      ...
      },
      {
        ...
        symptoms: 'Parestesia ocasional e relato de visao turva.',
        exposureSummary: 'Consumo de pescado local 3 a 4 vezes por semana.',
        clinicalNote: '',
        lastAction: 'Aguardando avaliacao',
        updatedAt: '23/04/2026 10:40',
      },
    ],
    agenda: [
  ...
  nurse: {
    kind: 'nurse',
    headline: 'Triagem de pacientes expostos.',
    summary:
      'Fila para enfermagem registrar sinais, classificar prioridade e encaminhar ao medico.',
    stats: [
      {
        label: 'Aguardando triagem',
        value: '06',
        detail: 'Pacientes que precisam de classificacao inicial.',
        tone: 'coral',
      },
      {
        label: 'Prioritarios',
        value: '03',
        detail: 'Gestantes, criancas ou sintomas neurologicos.',
        tone: 'gold',
      },
      {
        label: 'Encaminhados',
        value: '02',
        detail: 'Casos enviados para revisao medica.',
        tone: 'teal',
      },
      {
        label: 'Unidade',
        value: 'UBS fluvial',
        detail: 'Ponto de atendimento da fila atual.',
        tone: 'slate',
      },
    ],
    alerts: [
      {
        id: 'alert-nurse-1',
        title: 'Gestante com consumo frequente de peixe',
        level: 'critical',
        community: 'Barcelos',
        updatedAt: '24/04/2026 08:40',
        description: 'Priorizar sinais neurologicos, historico alimentar e encaminhamento medico.',
        action: 'Registrar triagem e enviar para o medico de plantao.',
      },
    ],
    cases: [],
    triageGuides: [
      'Confirmar comunidade, idade, gestacao e frequencia de consumo de peixe.',
      'Registrar tremor, dormencia, tontura, visao turva ou alteracao de equilibrio.',
      'Encaminhar ao medico gestantes, criancas e sintomas neurologicos progressivos.',
    ],
    queueNotes: [
      'A triagem organiza a fila antes da conduta medica.',
      'Casos de alto risco devem sair da triagem ja com proximo passo definido.',
    ],
  },
  collector: {
    kind: 'collector',
    ...
    changes: [
      {
        ...
        action: 'UPDATE',
        recordId: 'u-doc-01',
        summary: 'Usuario Medica Demo teve revisao recente de acesso.',
